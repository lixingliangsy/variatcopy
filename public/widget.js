 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="variatcopy" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "variatcopy";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "variatcopy") + "_chat_session";
