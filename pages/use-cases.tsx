    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">Two angles for every product, ready to test.</p>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-600"><span className="font-medium">How VariatCopy helps:</span> VariatCopy turns raw input into a reviewed, exportable result in minutes.</p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-600"><span className="font-medium">How VariatCopy helps:</span> Self-serve: paste input, get a structured deliverable and share it.</p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-600"><span className="font-medium">How VariatCopy helps:</span> VariatCopy is the drop-in layer they can white-label or embed.</p>
          </div>
          </div>
        </main>
