  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={NAME + " — How VariatCopy turns your input into a structured result in three steps."} />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-600">VariatCopy processes it with its rule set and returns a structured result.</p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-6">
