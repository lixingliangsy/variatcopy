    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-2 text-slate-600">A REST endpoint backs the web form, so you can call VariatCopy from your own pipeline. Webhook-ready: fulfillment events are delivered via the Waffo Pancake webhook.</p>
