  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={NAME + " — How VariatCopy handles your data and the compliance posture it maintains."} />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">Generate two contrasting copy angles for the same product - e.g. discount-led vs quality-led - each with a hook, body, and CTA, plus a one-line test hypothesis.</p>
          <h2 className="mt-8 text-xl font-semibold text-slate-900">What we handle</h2>
          <p className="mt-2 text-slate-600">VariatCopy processes the text or configuration you submit to produce its output. We do not train public models on your submissions without explicit consent.</p>
